...
wd = '/Users/Xavi/Dropbox/xavi-umh/RECERCA/treballs/BIMCV-COVID19/mapas' # ruta absoluta para evitar problemas por desplazamiento


# Importamos el csv como dataframe. 


df = pd.read_csv(os.path.join(wd,"data","MAP_INFO_GENERAL_RESUMEN_DEP_xavi2.csv"), sep =',', dtype={'DEPARTAMENTO':str})
...
NIL3 = folium.GeoJson(
    ...
    tooltip=folium.features.GeoJsonTooltip( # Caja de texto
        ...
        aliases=['Health department: ','Name: ', 'CX+DX'], # Texto que precede a las variables
        style=("background-color: white; color: #333333; font-family: arial; font-size: 12px; padding: 10px;") 
    )
).add_to(f3)
...
m.save(os.path.join(wd,"Departamentos2.html"))
